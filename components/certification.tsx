...
const AzureCert = ({
  ...
  return (
    <div className="flex items-center justify-center border border-black/[0.2] dark:border-white/[0.2] flex-col max-w-sm mx-auto p-4 relative h-[30rem] rounded-3xl top-8" style={{backgroundColor: 'rgb(18,16,14)', background: 'linear-gradient(90deg, rgba(18,16,14,1) 0%, rgba(17, 25, 40, 0.75) 100%)'}}>
